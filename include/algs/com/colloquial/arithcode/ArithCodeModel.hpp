#ifndef ARITHCODEMODEL_HPP
#define ARITHCODEMODEL_HPP
...
public:
     ...
     */
    virtual int pointToSymbol(int count) =0;
     ...
     */
    virtual void interval(int symbol, int* result) =0;
     ...
     */
    virtual bool escaped(int symbol) =0;
     ...
     * @since 1.1
     */
    virtual void exclude(int symbol) =0;
